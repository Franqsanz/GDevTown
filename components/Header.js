  ...
  return (
    <>
      <header>
        <nav>
          <Link href='/'>
            <a className="aLogo"><h1>GDevTown</h1></a>
          </Link>
          <ul>
            <li><a href="https://twitter.com/franqsanz" aria-label="twitter" className="aSocial">
            ...
            <li><a href="https://linkedin.com/in/franqsanzdev" aria-label="linkedin" className="aSocial">
            ...
            <li><a href="https://github.com/Franqsanz/" aria-label="github" className="aSocial">
            ...
            <li><a href="https://dev.to/franqsanz" aria-label="dev" className="aSocial">
