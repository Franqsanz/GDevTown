...
export const meta = {
  ...
  edit: 'https://github.com/Franqsanz/GDevTown/blob/main/pages/blog/como-activar-el-modo-oscuro-en-la-web-segun-la-preferencia-del-sistema-operativo/index.mdx'
}
