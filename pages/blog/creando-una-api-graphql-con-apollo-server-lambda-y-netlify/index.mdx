...
<a class="viewImg" href="/static/playground.png">
  <img src="/static/playground.png" alt="playground" />
</a>
...
Si te haz dado cuenta hay una dependencia que no hemos usado `encoding` está dependencia lo usará Netlify, por lo menos en mí caso debí instalarla ya que me daba un error al momento del despliegue.
...
📝 [Edit post on GitHub](https://github.com/Franqsanz/GDevTown/blob/main/pages/blog/creando-una-api-graphql-con-apollo-server-lambda-y-netlify/index.mdx)