...
export const meta = {
  id: 10,
  title: 'Como aplicar el "html lang" en next.js',
...
📝[Edit post on GitHub](https://github.com/Franqsanz/GDevTown/blob/main/pages/blog/como-aplicar-el-html-lang-en-next-js/index.mdx)